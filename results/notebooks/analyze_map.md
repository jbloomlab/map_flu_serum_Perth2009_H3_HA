...
### Beta diversity for each group
In order to determine how variable the selection is in each group, we compute the [beta diversity](https://esajournals.onlinelibrary.wiley.com/doi/10.1890/06-1736.1), using both the Shannon and Simpson indices.
We look only at post-vaccination samples, excluding the duplicate 2009 age 53 sample and not examing the spike-in experiment.
...
```
    ...
    serum_group
    Hensley_sera           1.230070
    VIDD_sera              1.196409
    antibody_lower_head    1.139691
    antibody_region_B      1.452823
    ferret                 1.135527
    dtype: float64
    
    simpson beta diversity:
    serum_group
    Hensley_sera           1.600488
    VIDD_sera              1.375323
    antibody_lower_head    1.379706
    antibody_region_B      1.594487
    ferret                 1.121852
    dtype: float64


Large beta diversity indicates more variability among the samples in a group.
As expected, the ferrets have lower diversity than the human sera.
This is especially pronounced when using the Simpson index, which emphasizes the effect of strong-selection sites.
...
![png](analyze_map_files/analyze_map_118_1.png)
...
![png](analyze_map_files/analyze_map_118_3.png)
...
![png](analyze_map_files/analyze_map_118_5.png)
...
![png](analyze_map_files/analyze_map_118_7.png)
...
![png](analyze_map_files/analyze_map_118_9.png)
...
![png](analyze_map_files/analyze_map_118_11.png)
...
![png](analyze_map_files/analyze_map_122_1.png)
...
![png](analyze_map_files/analyze_map_132_0.png)
...
![png](analyze_map_files/analyze_map_132_2.png)
...
![png](analyze_map_files/analyze_map_132_4.png)
...
![png](analyze_map_files/analyze_map_132_6.png)
...
![png](analyze_map_files/analyze_map_132_8.png)
...
![png](analyze_map_files/analyze_map_132_10.png)
...
![png](analyze_map_files/analyze_map_132_12.png)
...
![png](analyze_map_files/analyze_map_134_0.png)


    <ggplot: (8744359022719)>
    Saving figure to results/figures/VIDD_sera_rep_corr.pdf
    Saving figure to results/figures/VIDD_sera_rep_corr.svg



![png](analyze_map_files/analyze_map_134_2.png)


    <ggplot: (8744358702870)>
...
![png](analyze_map_files/analyze_map_134_10.png)


    <ggplot: (8744359031374)>
...
![png](analyze_map_files/analyze_map_134_12.png)


    <ggplot: (-9223363292486854961)>
...
![png](analyze_map_files/analyze_map_136_12.png)


    <ggplot: (8744367265649)>
